...
/**
 * A {@link ReferenceTable} holds details for all the files with a single type, such as checksums, versions and
 * archive members. There are also optional fields for identifier hashes and whirlpool digests.
 * 
 * @author Graham
 * @author `Discardedx2
 * @author Sean
...
public class ReferenceTable {
	...
	/**
	 * A flag which indicates this {@link ReferenceTable} contains {@link BKDR} hashed identifiers.
	 */
	...
	/**
	 * A flag which indicates this {@link ReferenceTable} contains compression sizes.
	 */
